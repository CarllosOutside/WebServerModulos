...
struct server_module* module_open (const char* module_name)
{
  ...
  module_generate = (void (*) (int, char*)) dlsym (handle, "module_generate");
  ...
  module->generate_function = module_generate; /*modulo retornado executara dada funcao da biblioteca linkada*/
